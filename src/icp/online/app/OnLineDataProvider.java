...
public class OnLineDataProvider extends Observable {
	...
	/**
	 * Pole, ve kterém budou uloženy prùmìrné hodnoty EEG signálu pro jednotlivé èislice
	 * index pole oznaèuje dané èislo (0-9)
	 */
	private Epocha[] epochaCisla;

	/**
	 * Zapisovaè pro ukládání poètu podobností jednotlivých (zprùmìrovaných) epoch s P-300 vlnou.
	 */
	//private Zapisovac zapisovac;


	/**
	 * Bufer, který se bude používat pro ukládání hodnot z datových objektù RDA_MessageData
	 */
	 ...
	 * Tato vlna se nastaví pomocí O-Q testu, a náíslednì se používá k porovnávání s
	 * prùmìrnými epochami èíslic
	 */
