...
public class OnLineDataProvider extends Observable {
    ...
    /**
     * Pole, ve kterém budou uloženy prùmìrné hodnoty EEG signálu pro jednotlivé
     * èislice index pole oznaèuje dané èislo (0-9)
     */
    private Epocha[] epochaCisla;

    /**
     * Zapisovaè pro ukládání poètu podobností jednotlivých (zprùmìrovaných)
     * epoch s P-300 vlnou.
     */
    ...
    /**
     * @return dostupné epochy pro všechny dostupné kanály. [index_kanálu (FZ ==
     * 0, CZ == 1, PZ == 2)] [index_stimulu (numbers from 1 to 9 . Object on
     * zero index is not used)] [index_epochy (from 0 to 9)]
