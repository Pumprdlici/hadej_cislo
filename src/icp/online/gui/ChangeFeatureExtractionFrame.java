		...
		okBttn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (fasBttn.isSelected()) {
					...
					ChangeClassifierFrame cc = new ChangeClassifierFrame(mainFrame);
					...
					JOptionPane.showMessageDialog(null, "Choose one Feature Extraction method and fill in its parameters");
