 ...
 * odsazením v datovém bloku (mùže být od 0 až po velikost tohoto bloku) a poètu obsažených
 * datových blokù (toto èíslo je standartnì 1). Dále obsahuje inforamci o tom ke které elektrodì 
 * pøísluší. Jelikož však server doposud nemá implemetovanou funkci pro zasílání markerù pouze z
 * urèitého poètu elektrod, je tato hodnota standartnì nastavena na -1, což znamená, že platí pro
 * všechny elektrody. Nejdùležitìjší èástí tohoto objektu je však informace o názvu tohoto impulzu,
 * která je oddìlená nulovými znaky (/0).
 */
