 ...
 * @version 1.0
 * 
 * Tato tøída reprezentuje datový objekt který pøichází ze serveru. Je vždy oznaèen
 * unikátní posloupností bajtù. Nese informace o typu a velikosti následujícího datového
 * bloku. Tuto hlavièku obsahují všechny ostatní datové objekty (s výjimkou objektu typu
